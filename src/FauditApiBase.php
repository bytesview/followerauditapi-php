...
class FauditApiBase {
     ...
     * @var string
     */
    private const API_HOST          =   'https://www.followeraudit.com';
    ...
    private function _request(string $url, string $method, array $postfields,string $api_key, bool $json = false): string 
    {
        ...
        $options[CURLOPT_HTTPHEADER]    =   ['Accept: application/json','bearer-token: '.$api_key];
        ...
        if (curl_errno($curlHandle) > 0) {
            ...
            throw new FauditAPIException($error, $errorNo);
        }
